...
public class client extends javax.swing.JDialog {
    ...
    ArrayList<Client_model> clientList=controller.getclientnom(jTrecherche.getText());
        for (Client_model client_model : clientList) {
            jTcin.setText(client_model.getN_CIN());
            jTnom.setText(client_model.getNom());
            jTtelephone.setText(client_model.getTel());
        break;    
        }
    ...
    private void jBenregistrerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBenregistrerActionPerformed
        ...
        model.setN_CIN(jTcin.getText());
        model.setNom(jTnom.getText());
        model.setTel(jTtelephone.getText());
        controller.ajouterclient(model);
    ...
    private void jBsuppressionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBsuppressionActionPerformed
        ...
        ArrayList<Client_model> clientList=controller.getclientnom(jTrecherche.getText());
        for (Client_model client_model : clientList) {
        controller.supprimerrclient(client_model);
        break;    
        }
